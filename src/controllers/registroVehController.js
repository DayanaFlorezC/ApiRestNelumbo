...
const createRegistroVehController = async (req, res) =>{
    try {
        ...
        if(!newRegister) return res.json({success: false, mensaje: 'No se puede Registrar Ingreso, ya existe la placa en este u otro parqueadero o el parqueadero esta lleno'})
...
const getRegistrosVehController = async (req, res) =>{
    try {
        ...
        if(!registros) return res.json({success: false, mensaje: 'No hay registros'})
...
const getRegistroByIdVehController = async (req, res) =>{
    try {
        ...
        if(!registro) return res.json({success: false, mensaje: 'Registro no encontrado'})
